...
<div class="container">
    ...
    <f:form action="${pageContext.request.contextPath}/admin/khuyen-mai/update" method="POST" modelAttribute="km">
        ...
        <f:input type="text" class="form-control" value="${km1.idkhuyenmai }" id="exampleInputEmail4" name="idkhuyenmai" path="idkhuyenmai" readonly="true"/>
        <br>

        <label for="exampleInputEmail1"> Mã KM <span style="color:red">*</span> :</label>
        <f:input type="text" class="form-control" value="${km1.makhuyenmai}" id="exampleInputEmail1" name="mota" path="makhuyenmai"/>
        ...
        <f:input type="text" class="form-control" id="exampleInputEmail1"  value="${km1.tenkhuyenmai}" name="tenkhuyenmai" path="tenkhuyenmai"/>
        ...
        <f:input type="text" class="form-control" value="${km1.chietkhau}" id="exampleInputEmail1" name="chietkhau" path="chietkhau"/>
        ...
        <f:input type="date" class="form-control" value="${km1.ngaybatdau}" id="exampleInputEmail1" name="ngaybatdau" path="ngaybatdau"/>
        <br>

        <label for="exampleInputEmail1"> Ngày Kết Thúc <span style="color:red">*</span> :</label>
        <f:input type="date" class="form-control" value="${km1.ngayketthuc}" id="exampleInputEmail1" name="ngayketthuc" path="ngayketthuc"/>
        <br>

        <label for="exampleInputEmail1"> Ngày Tạo <span style="color:red">*</span> :</label>
        <f:input type="date" class="form-control" value="${km1.ngaytao}" id="exampleInputEmail1" name="ngaytao" path="ngaytao"/>
        <br>

        <label for="exampleInputEmail1"> Ngày Cập Nhật <span style="color:red">*</span> :</label>
        <f:input type="date" class="form-control" value="${km1.ngaycapnhat}" id="exampleInputEmail1" name="ngaycapnhat" path="ngaycapnhat"/>
        <br>

        <label for="exampleInputEmail1"> Trạng Thái <span style="color:red">*</span> :</label>
        <f:input type="text" class="form-control" value="${km1.trangthai}" id="exampleInputEmail1" name="trangthai" path="trangthai"/>
        ...
        <f:select class="form-control" path="loaiKhuyenMai">
            <c:forEach items="${listKM}" var="sp">
                <f:option value="${sp.idloaikhuyenmai}" selected="${sp.idloaikhuyenmai==km1.loaiKhuyenMai.idloaikhuyenmai?'true':''}">${sp.idloaikhuyenmai}</f:option>
            </c:forEach>
        </f:select> <br>
