...
<h1 style="text-align: center;"><i class="fa-solid fa-file-invoice"></i> Quản Lý Kiểu Dáng  </h1>
<br>
<div class="btnThem">
    <button type="button" class="btn btn-info"><a href="${pageContext.request.contextPath }/admin/kieu-dang/add"><i
            class="fa-solid fa-circle-plus"></i> Thêm kiểu dáng  </a></button>
</div>
<br>
<table class="table">
    <tr>
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-warning btnSua"><a
                            href="${pageContext.request.contextPath}/admin/kieu-dang/update/${p.idkieudang}"><i
                            class="fa-solid fa-wrench"></i> Sửa</a></button>
                    <button type="button" class="btn btn-danger btnSua"><a
                            href="${pageContext.request.contextPath}/admin/kieu-dang/delete/${p.idkieudang }"><i
