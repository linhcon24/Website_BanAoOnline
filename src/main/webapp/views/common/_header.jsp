      ...
      <a class="navbar-brand" href="index"><img class="logo" src="${pageContext.request.contextPath}/views/img/1.gif"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" >
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item menu">
              <a class="chu-m" href="${pageContext.request.contextPath}/product"><i class="fa-brands fa-shopify"></i>Sản Phẩm</a>
            </li>
            <li class="nav-item menu">
    		...
    		<c:if test="${account.role ==0 }"><li class="nav-item menu">
              <a class="chu-m" href="${pageContext.request.contextPath}/admin/products"><i class="fa-brands fa-product-hunt"></i></a>
            </li>
            <li class="nav-item menu">
              <a class="chu-m" href="${pageContext.request.contextPath}/users/user"><i class="fa-solid fa-users-gear"></i></a>
            </li>
             </c:if>
          ...
          <div class="button-cangiua">
           ...
           <div style="margin-left: 65px"><a  style="color: white" href="?language=vi"><img style="width: 20px" src="${pageContext.request.contextPath }/views/img/co-viet-nam.png"></a> | <a style="color: white"  href="?language=en"> <img style="width: 20px" alt="" src="https://s2.o7planning.com/templates/o7planning/resources/images/languages/en.png"> </a></div>
